...
function adsense_inpost_ads_add_pages() {
    ...
    add_options_page('AdSense In-Post Options','AdSense In-Post', 'manage_options', 'inpost-ads', 'adsense_inpost_ads_settings_page');
}
...
function adsense_inpost_ads_settings_page() {
	...
	<div class="wrap">
		...
		<p><?php _e( 'You can enter up to three different sets of ad codes to use in your pages and posts. You can create a number of different styled image or text based ads.', 'adsense-inpost-ads' ); ?></strong></p>
